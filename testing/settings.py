"""
Django settings for gmca_portal project.
...
from gmca_portal.apps import SEARCH_INDEXES  # noqa
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'gmca_portal' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGGING = {
    ...
    'loggers': {
        ...
        'gmca_portal': {'handlers': ['stream'], 'level': 'INFO'},
    },
}
